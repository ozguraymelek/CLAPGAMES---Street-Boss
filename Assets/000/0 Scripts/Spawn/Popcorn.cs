...
public class Popcorn : MonoBehaviour
{
    ...
    [SerializeField] private PopcornFoodArea foodAreaRef;
    ...
    public int countSpawnedPopcorn = 0;
    ...
    private void Completed(Transform instanceTransform)
    {
        ...
        StackManager.Instance.standPopcornFoods.Add(instanceTransform.transform);
        
        instanceTransform.parent = foodAreaRef.standPoints[foodAreaRef.indexStandPopcorn].transform;
        instanceTransform.localPosition = Vector3.zero;
        instanceTransform.localScale = Vector3.one;
        
        foodAreaRef.indexStandPopcorn++;
    }
}
